...
def generate_csrf_token():
    """
    Under glorious name of csrf token we are hiding simple 12 caracters password
    """
...
def credentials_to_dict(credentials):
    """
    Converting Google credentials into serializable object, so we can save it to session
    """
